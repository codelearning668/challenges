...
import static sk.mkrajcovic.challenges.architecture.ArchitectureTestUtil.createRuleForClassesWhithNameEndingAndAnnotations;
...
class ControllerArchitectureTest {
	...
	void checkControllerLayerAccessibility() {
		...
		assertDoesNotThrow(() -> layeredArchitecture.check(CLASSES));
	}
