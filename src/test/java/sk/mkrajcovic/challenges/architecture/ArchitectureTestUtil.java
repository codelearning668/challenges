...
class ArchitectureTestUtil {
	...
	static final JavaClasses CLASSES = new ClassFileImporter()
			.withImportOptions(List.of(Predefined.DO_NOT_INCLUDE_TESTS, Predefined.DO_NOT_INCLUDE_JARS))
			.importPackages("sk.mkrajcovic.challenges");
